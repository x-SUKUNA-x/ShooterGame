...
import zombie3 from "../../assets/3.png";
import zombie4 from "../../assets/4.png";
import zombie5 from "../../assets/5.png";

function Target({ score, setScore }) {
  const zombieArray = [zombie1, zombie2, zombie3, zombie4, zombie5];
  let zombie = 0;
